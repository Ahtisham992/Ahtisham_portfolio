...
// TASK 6.3: Renamed "Who I Am" → "About Me".
//           /intro route already defaults to PhotoIntro in App.jsx.
// ========================================
import React, { useState, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import {
  Menu, X, Sun, Moon,
  Home, User, Code2, Briefcase, Mail, FolderOpen,
} from 'lucide-react';
...
const Navbar = () => {
  ...
  // TASK 6.3: "Who I Am" → "About Me"
  const navItems = [
    { name: 'Home',             href: '/',          icon: Home,       type: 'route'  },
    { name: 'About Me',         href: '/intro',     icon: User,       type: 'route'  }, // renamed
