...
// TASK 4.2: Honeypot anti-spam field added to form.
//           If the hidden field has a value on submit the request
//           is silently dropped without calling EmailJS.
//
// TASK 6.2: Replaced deprecated `emailjs-com` with `@emailjs/browser`.
//           Run: npm uninstall emailjs-com && npm install @emailjs/browser
//
// TASK 4.2 REMINDER (manual step):
//   Go to https://dashboard.emailjs.com → Email Services → your service
//   → Allowed Origins and add ONLY "https://ahtisham-dev.site"
//   so the service rejects requests from any other origin.
// ========================================
...
import {
  ...
  Github, Instagram, CheckCircle, AlertCircle,
} from "lucide-react";
import { personalInfo } from "../data/portfolio";
import emailjs from "@emailjs/browser";   // TASK 6.2 — updated package
...
const Contact = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    subject:   "",
    message:   "",
    honeypot:  "",   // TASK 4.2 – hidden spam-trap field
  });
  ...
  const handleSubmit = async (e) => {
    ...
    // TASK 4.2 – honeypot check: bots fill hidden fields; humans don't.
    if (formData.honeypot) {
      // Silently reject — don't alert the bot that it was caught.
      return;
    }
    ...
    try {
      await emailjs.send(
        "service_ntd8qaa",   // EmailJS Service ID
        "template_we8jt3l",  // EmailJS Template ID
        {
        ...
        "HF9NDuUkZ7bfuNXto"  // EmailJS Public Key
      );
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div>
              <h4 className={`text-lg font-bold ${themeClasses.textPrimary} mb-4`}>
                Follow Me
              </h4>
          ...
          >
            ...
            >
              {/*
                TASK 4.2 — Honeypot field.
                Hidden from real users via CSS; bots auto-fill it.
                Never send this value to EmailJS.
              */}
              <input
                type="text"
                name="honeypot"
